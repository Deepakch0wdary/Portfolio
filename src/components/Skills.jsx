  ...
  const skillsData = [
    {
      ...
      description: 'Core procedural, object-oriented, and scripting languages.',
    ...
    },
    {
      ...
      description: 'Building modern frontend interfaces and backend API services.',
      skills: ['HTML', 'CSS', 'JavaScript', 'React.js', 'Node.js', 'REST APIs'],
    ...
    },
    {
      ...
      description: 'Strong foundations in theoretical and practical systems engineering.',
    ...
    },
    {
      ...
      skills: ['Git', 'GitHub', 'VS Code', 'Vercel', 'MS Excel', 'Data Entry'],
      colSpan: 'md:col-span-2 lg:col-span-1',
