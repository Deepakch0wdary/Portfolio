      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-white/60 font-mono text-[9px] md:text-[10px]">
            &copy; {new Date().getFullYear()} V.DEEPAK. All rights reserved.
          </p>
        </div>
        
        <div className="flex flex-col gap-1 md:items-center">
          <a href="mailto:v.deepak332100@gmail.com" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 lowercase">v.deepak332100@gmail.com</a>
          <a href="tel:+919483272589" className="hover:text-white transition-colors mt-2" aria-label="Call Me" title="Call Me">
