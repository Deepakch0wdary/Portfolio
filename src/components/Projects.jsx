...
const Projects = () => {
  const projects = [
    {
      title: "IntelliTask",
      subtitle: "AI-Powered Task Management App",
      description: "Designed and developed a smart task management web application featuring AI-based task organization, priority management, progress tracking, and responsive user experience. Deployed on cloud infrastructure for real-time accessibility and productivity enhancement.",
      image: project1Img, 
      link: "https://intelli-task001.vercel.app/",
      features: [
        "AI-based task organization and priority classification",
        "Real-time task tracking with progress analytics",
        "Responsive layout optimized for mobile and desktop screens",
        "Cloud infrastructure deployment for maximum accessibility"
      ],
      techStack: ["React", "Node.js", "Generative AI APIs", "Tailwind CSS", "Vercel"],
    },
    {
      title: "AI Startup Idea Validator",
      subtitle: "Instant Business Intelligence Generator",
      description: "Stop building what nobody wants. Get a complete business roadmap, competitor SWOT analysis, financial models, and investor-ready pitch decks instantly using advanced LLMs.",
      image: project2Img, 
      link: "https://ai-idea-validator002.vercel.app",
      features: [
        "Instant competitor SWOT analysis generation",
        "Comprehensive business roadmap flowcharting",
        "Automated financial projection models",
        "Investor-ready pitch deck builder & exporter"
      ],
      techStack: ["Python", "React.js", "LLMs / Prompting", "Tailwind CSS", "Vercel"],
    },
    {
      title: "SSR Enterprises",
      subtitle: "Business ERP & Inventory Management System",
      description: "Developed a full-stack ERP platform for managing electrical spare parts, inventory, suppliers, customers, enquiries, estimates, invoices, GST, and business analytics with role-based administration and AI-assisted product search.",
      image: project3Img, 
      link: "https://github.com/Deepakch0wdary",
      features: [
        "Role-based administration and user permission management",
        "Comprehensive invoice, estimate, and GST calculation engine",
        "AI-assisted product search and stock inventory level alerts",
        "Business analytics dashboard with financial tracking"
      ],
      techStack: ["React.js", "Node.js", "Database (DBMS)", "REST APIs", "Tailwind CSS"],
    },
  ];
