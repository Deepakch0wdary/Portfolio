  ...
  const certifications = [
    {
      ...
      organization: 'Google',
      description: 'Specialized training focused on designing high-quality prompts, using generative AI tools, and optimizing LLM output workflows.',
    },
    {
      title: 'Practical Machine Learning',
      organization: 'Coursera',
      description: 'Comprehensive coursework covering key supervised and unsupervised ML models, neural networks, and model training methodologies.',
    },
    {
      title: 'A Complete Reinforcement Learning System',
      organization: 'Coursera',
      description: 'Deep study of reinforcement learning concepts including Markov Decision Processes, Q-learning, and policy optimization.',
    },
    {
      title: 'Fundamentals of Network Communication',
      organization: 'Coursera',
      description: 'In-depth understanding of standard computer network architectures, protocol stacks (TCP/IP), and network traffic routing.',
    },
  ];
